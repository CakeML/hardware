structure BetterLECLib =
struct

open hardwarePreamble;

open BetterLECTheory;
...
fun betterlec extenv_def regs_def nl_def nlnew_def = let
 ...
 val th = SPECL [nl, nlnew, regs, extenv] circut_run_cong
 val th = EVAL_MP th
 ...
 val precond = prove(th |> concl |> lhand,
                     ...
                     match_mp_tac cell_inp_rel_reg_inp_rel \\ cell_inp_run_eq_tac)
 val th = MP th precond
